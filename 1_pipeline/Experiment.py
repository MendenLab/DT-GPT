...
import plotnine
import matplotlib
from ArchivedFunctions import OldExperiment
...
class Experiment:
    ...
    def _create_experiment_folder(self, timestamp_to_use):
        # Generate experiment folder from experiment_folder_root + experiment_class_name + experiment_name + datetime + nickname
