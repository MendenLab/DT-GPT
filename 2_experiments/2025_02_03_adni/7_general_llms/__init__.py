...
sys.path.append(base_path + "2_experiments/2024_02_05_critical_vars/4_dt_gpt_meditron/scripts")
sys.path.append(base_path + "1_pipeline/data_generators/multivariate")